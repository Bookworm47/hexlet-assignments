...
class AppTest {
    ...
    void testReverseSequence() {
        String line = "clever";
        CharSequence rs = new ReversedSequence(line);
        String revLine = "revelc";
        assertThat(revLine).isEqualTo(rs.toString());
        assertThat(revLine.charAt(1)).isEqualTo(rs.charAt(1));
        assertThat(revLine).hasSize(rs.length());
        assertThat(revLine.subSequence(1, 4)).isEqualTo(rs.subSequence(1, 4));
    }

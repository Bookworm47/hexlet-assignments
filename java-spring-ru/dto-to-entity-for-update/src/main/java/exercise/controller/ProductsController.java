...
public class ProductsController {
    ...
    public ProductDTO update(@RequestBody ProductUpdateDTO productUpdateDTO, @PathVariable long id) throws Exception {
        var product = productRepository.findById(id)
                .orElseThrow(() -> new ResourceNotFoundException("Product with id " + id + " not found"));
        updatedToEntity(productUpdateDTO, product);
        productRepository.save(product);
    ...
    private Product updatedToEntity(ProductUpdateDTO productUpdateDTO, Product product) {
